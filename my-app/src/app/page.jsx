    ...
    <>
      <header className="Container mx-auto">
        <nav className="flex max-w-screen-xl flex flex-wrap items-center justify-around mx-auto p-2  ">
          ...
          <Link className="li" href="/archive">Archive</Link>
          <Link className="li" href="/pro">Pro Version</Link>
          <Link className="li" href="/download">Download</Link>
        </nav>
      </header>
        ...
        <>
            <div key={product.id} className="w-full md:w-1/2 lg:w-1/4 xl:w-1/4 p-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4 my__images">
                <img src={product.image} width={150} height={100} alt={product.title} className="imagess" />
        ...
        <>
            ...
            <Link href={`${product.id}`}>
              <div className="border border-gray-200 rounded-lg p-4">
                <img src={product.image} width={150} height={100} alt={product.title} className="imagesss" />
                <h2 className="text-lg font-semibold mt-2">{product.title}</h2>
                                <p className="text-gray-800 font-bold mt-2">${product.price}</p>
              </div>
              </Link>
